...
--ALTER USER ORDS_METADATA ACCOUNT UNLOCK identified by "Vnpay!1234";
ALTER USER ORDS_PUBLIC_USER ACCOUNT UNLOCK identified by "Vnpay!1234";
--ALTER USER ORDSYS ACCOUNT UNLOCK identified by "Vnpay!1234";
```
